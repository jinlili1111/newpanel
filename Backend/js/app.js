...
var App = function() {
    ...
    var uiInit = function(requestOne) {
        ...
        $('[data-toggle="lightbox-image"]').magnificPopup({ type: 'image', image: { titleSrc: 'title' }, mainClass: 'lightbox-image-top' });
        ...
        // Initialize single image lightbox
        $('[data-toggle="simple-ajax-popup"]').magnificPopup({ type: 'ajax' });
    ...
    /*jQuery Expander Plugin v1.3.1 class = "expander" */
    var initExpander = function (slicePoint) {
        ...
        $(".expander").expander({
            ...
            widow: 2,
            expandEffect: 'show',
            expandText: "<span style=\"font-size:11px;white-space:nowrap\"> <i class=\"gi gi-zoom_in\"></i></span>",
            userCollapseText: '<span style=\"font-size:11px;white-space:nowrap\"> <i class=\"gi gi-zoom_out\"></i></span>'
        });
    }
    ...
    return {
        init: function (requestOne) {
            uiInit(requestOne); // Initialize UI Code
            pageLoading(); // Initialize Page Loading
            initExpander(); //Initialize Expander
        },
